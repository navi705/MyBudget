...
void main() {
  ...
  group('calculateAssetStats - cross-currency linked pairs', () {
    test('invested converts the cash leg using a DIRECT rate when the linked '
    ...
    test('realized converts the cash leg using an INVERSE rate when only the '
  ...
  group('calculateAssetStats - linkedTransactionId with a missing leg', () {
    test('a linkedTransactionId pointing at a transaction absent from the '
