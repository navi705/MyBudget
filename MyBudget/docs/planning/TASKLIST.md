...
Проблемы:
1. Отображение если выкачивать все данных из дб спутся пару лет будет виснуть надо оптимизировать. Сделать прокрутку
2. Сделать через seed пресеты для тестирования данных
