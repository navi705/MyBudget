...
21. Посмотреть на опимизацию с большим колчество валют при перваом запуске может тоже поставить бачами писатся
...
25. Оптимизровать seeders
26. Сделать workshop с темами для этого нужна полная кастомизация интерфейса
27. 

1. добавить кол-во общих транзакий
2. добавить переход даты по стерелкам и загрузка данным то есть прокинуть евент
...
8. сделать сохранение в бд настроек с
...
Проблемы:
1. Отображение если выкачивать все данных из дб спутся пару лет будет виснуть надо оптимизировать. Сделать прокрутку (получаею прокрутку но всё равно он хранит всё в оперативе)
